...
const sms = (conn, m, store) => {
    ...
    m.reply = async (content, opt = { packname: "JFX MD-X", author: "JEPHTER TECH" }, type = "text") => {
    ...
    m.senddoc = (doc, type, id = m.chat, option = {
        mentions: [m.sender],
        filename: "JEPHTER TECH",
        mimetype: type,
        externalAdRepl: {
            title: "JEPHTER TECH",
            body: 'Join the Official JFX MD-X WhatsApp Channel',
            thumbnailUrl: ``,
            thumbnail: log0,
            mediaType: 1,
            mediaUrl: '',
            sourceUrl: 'https://whatsapp.com/channel/0029VbAxkJl0lwgqAOojKI3R',
        }
    }) => conn.sendMessage(id, {
        document: doc,
    ...
    m.sendcontact = (name, info = "JEPHTER TECH", number) => {
